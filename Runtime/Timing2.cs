...
namespace MEC
{
    public class Timing2 : MonoBehaviour
    {
        ...
        private static Timing2[] ActiveInstances = new Timing2[16];
        private static Timing2 _instance;

        public static Timing2 Instance
        {
            get
            {
                if (_instance == null || !_instance.gameObject)
                {
                    ...
                    _instance = instanceHome.GetComponent<Timing2>() ?? instanceHome.AddComponent<Timing2>();
        ...
        public static Timing2 GetInstance(byte ID)
        {
            if (ID >= 0x10)
                return null;
        ...
        {
            Timing2 inst = GetInstance(otherCoroutine.Key);
        ...
        public static float WaitUntilDone(AsyncOperation operation)
        {
            ...
            Timing2 inst = GetInstance(CurrentCoroutine.Key);
    ...
    public static class MECExtensionMethods1
    {
        ...
        {
            return Timing2.RunCoroutine(coroutine);
        }
        ...
        {
            return Timing2.RunCoroutine(coroutine, tag);
        }
        ...
        {
            return Timing2.RunCoroutine(coroutine, segment);
        }
        ...
        {
            return Timing2.RunCoroutine(coroutine, segment, tag);
        }
    }
}
...
public static class MECExtensionMethods2
{
    ...
    {
        while (MEC.Timing2.MainThread != System.Threading.Thread.CurrentThread || (gameObject && gameObject.activeInHierarchy && coroutine.MoveNext()))
    ...
    {
        while (MEC.Timing2.MainThread != System.Threading.Thread.CurrentThread || (gameObject1 && gameObject1.activeInHierarchy &&
